...
import { ExtensionContext, DashboardData, WebviewMessage } from '../types';

export class DashboardWebviewProvider implements vscode.WebviewViewProvider {
    public static readonly viewType = 'autoContextEngineer.dashboard';
    ...
    public resolveWebviewView(
        ...
        webviewView.webview.onDidReceiveMessage(
            ...
            undefined,
            this.extensionContext.vscodeContext.subscriptions
        );
    ...
    private async openContext(contextId: string): Promise<void> {
        try {
    ...
    private async openSummary(summaryId: string): Promise<void> {
        try {
