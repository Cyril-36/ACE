...
import { ExtensionContext, SettingsData, WebviewMessage } from '../types';

export class SettingsWebviewProvider implements vscode.WebviewViewProvider {
    public static readonly viewType = 'autoContextEngineer.settings';
    ...
    private async updateSettings(settings: SettingsData): Promise<void> {
        try {
            const config = vscode.workspace.getConfiguration('autoContextEngineer');
